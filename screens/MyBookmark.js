...
const MyBookmark = ({ navigation }) => {
    ...
    const renderMyBookmarkSalons = () => {
        ...
        return (
            <View style={[styles.flatContainer,{ backgroundColor: dark ? COLORS.dark1 : COLORS.tertiaryWhite}]}>
                <View style={[styles.categoryContainer, { backgroundColor: dark ? COLORS.dark1 : COLORS.tertiaryWhite }]}>
                    <FlatList
                        data={category}
