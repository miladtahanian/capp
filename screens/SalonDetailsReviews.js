...
const SalonDetailsReviews = ({ navigation }) => {
          ...
          <TouchableWithoutFeedback
            ...
            <View style={[styles.modalContainer]}>
              <View style={[styles.modalSubContainer, {
                ...
                />
                <TextInput
                  placeholder="The barbers & stylists are great 🔥"
   ...
   const renderContent = ()=>{
    ...
    const filteredReviews = selectedRating === "All" ? salonReviews : salonReviews.filter(review => review.avgRating === selectedRating);
    return (
        <ScrollView
...
export default SalonDetailsReviews